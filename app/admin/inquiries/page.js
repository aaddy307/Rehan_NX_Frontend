    ...
    <div>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-white rounded-xl p-8 text-center text-gray-500">No inquiries yet</div>
        ) : (
            ...
            <div key={inquiry._id} className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-400 mt-2">{new Date(inquiry.createdAt).toLocaleString()}</p>
                </div>
